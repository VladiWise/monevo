...
export async function POST(request: NextRequest) {
  ...
  return NextResponse.json(
    { message: "FundB created successfully" },
    { status: 201 }
  );
}
...
export async function PUT(request: NextRequest) {
  ...
  await FundB.findByIdAndUpdate(id, {
    accountId,
    name,
    ticker,
    currency,
  ...
  return NextResponse.json(
    { message: "FundB updated successfully" },
    { status: 200 }
  );
}
...
export async function DELETE(request: NextRequest) {
  ...
  await FundB.findByIdAndDelete(id);

  return NextResponse.json(
    { message: "FundB deleted successfully" },
    { status: 200 }
  );
}
...
export async function PATCH(
  ...
  try {
    ...
    if (!fund) {
      return NextResponse.json({ message: "FundB not found" }, { status: 404 });
    }
