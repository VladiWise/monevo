...
export async function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full h-16 items-center justify-between z-50 p-2 md:px-[8rem]  lg:px-[12rem]  flex bg-white  dark:bg-[#1D202A] border-b border-gray-200 dark:border-[#2F3441] ">
