...
export function AssetInfoCard({
  ...
  return (
    <>
      <section
        className="flex items-center justify-between py-3 px-1 gap-3 cursor-pointer hover:bg-darkMain/40 hover-none:active:bg-darkMain/80 active:bg-darkMain/80 transition-colors duration-300 ease-in-out"
        onClick={handleClick}
